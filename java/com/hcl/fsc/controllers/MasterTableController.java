...
public class MasterTableController {
	...
	public ResponseEntity<String> addMasterTableValues(@RequestBody MasterTablePossibleValues masterTablePossibleValues){
		...
		return ResponseEntity.status(HttpStatus.OK).body("Data saved sucessfully");
			...
			return ResponseEntity.ok("VALUE or KEY is null or empty");
